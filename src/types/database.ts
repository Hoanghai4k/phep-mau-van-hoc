...
// These aliases make it easier to reference Supabase row types
// throughout the codebase without deep-indexing Database["public"]["Tables"].
// DO NOT remove when regenerating types — append after the generated block.

type _PublicTables = Database["public"]["Tables"];

export type DbCategory = _PublicTables["categories"]["Row"];
export type DbProduct = _PublicTables["products"]["Row"];
export type DbProductFile = _PublicTables["product_files"]["Row"];
export type DbProductPreview = _PublicTables["product_previews"]["Row"];
export type DbPaymentAttemptUpdate = _PublicTables["payment_attempts"]["Update"];
